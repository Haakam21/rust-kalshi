...
pub struct GetPositionsResponse {
    ...
    pub event_positions: Vec<models::EventPosition>,
    /// List of market positions.
    #[serde(rename = "market_positions")]
    pub market_positions: Vec<models::MarketPosition>,
}

impl GetPositionsResponse {
    pub fn new(event_positions: Vec<models::EventPosition>, market_positions: Vec<models::MarketPosition>) -> GetPositionsResponse {
